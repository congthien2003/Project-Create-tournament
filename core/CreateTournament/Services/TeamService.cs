...
namespace CreateTournament.Services
{
    public class TeamService : ITeamService
    {
        ...
        public async Task<List<TeamDTO>> CreateListTeamAsync(int quantity, int IdTournament)
        {
            var teams = await _teamRepo.CreateListTeamAsync(quantity, IdTournament);
        ...
        public async Task<List<TeamDTO>> GetListTeamSwap(int idTournament, int round)
        {
            var listIdTeam = await _teamRepo.GetListTeamSwap(idTournament, round);
            return _mapper.Map<List<TeamDTO>>(listIdTeam);
        }
